...
- 내 리뷰 조회 / 수정 / 삭제
- 리뷰 작성
- 상품 상세 리뷰 요약 카드 / 별점 분포 / 정렬 / 필터 / 포토 리뷰 / 도움이 돼요
- 주문 미리보기 / 주문 생성 / 주문 조회 / 주문 취소
- 비회원 주문 조회 / 주문 목록 조회
- 대량 데모 상품/회원/리뷰 시드 데이터 생성 (포토 리뷰/도움표/구매 인증 포함)
...
- 인증/세션, 장바구니, 주문, 리뷰 작성·수정·삭제·도움이 돼요·관리자 검수 흐름 검증 포함
