  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-[1200px] items-center px-6 py-12 sm:px-8 lg:px-10">
      <div className="grid w-full gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <section className="admin-dark p-8 sm:p-10 lg:p-12">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-3">
            <article className="border border-white/10 bg-white/6 p-5">
        ...
        <section className="admin-card p-8 sm:p-10 lg:p-12">
