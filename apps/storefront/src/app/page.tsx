        ...
        <div className="grid gap-6">
          {home.featuredCategories.slice(0, 2).map((category) => (
            <Link
              ...
              className="surface-card rounded-[30px] bg-[rgba(255,255,255,0.7)] p-6 transition hover:translate-y-[-2px]"
            >
