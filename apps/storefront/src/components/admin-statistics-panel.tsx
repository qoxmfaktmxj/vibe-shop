...
export function AdminStatisticsPanel({
  ...
  const maxDailyRevenue = Math.max(
    ...statistics.dailyMetrics.map((item) => item.paidRevenue),
    0,
  );
    ...
    <article className="admin-card rounded-[36px] p-8">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-[var(--ink-soft)]">
            최근 7일, 30일 흐름을 나눠 보고 매출과 신규 회원 증가를 함께 확인할
            수 있게 정리했습니다.
          </p>
        </div>
      </div>
      ...
      <div className="mt-8 grid gap-4 xl:grid-cols-2">
        <div className="rounded-[28px] border border-[var(--line)] bg-white/72 p-6">
          <p className="eyebrow text-[var(--ink-soft)]">최근 7일</p>
        ...
        <div className="rounded-[28px] border border-[var(--line)] bg-white/72 p-6">
          <p className="eyebrow text-[var(--ink-soft)]">최근 30일</p>
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            <p className="rounded-[22px] bg-[rgba(214,81,45,0.06)] px-4 py-3 text-sm">
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-[28px] border border-[var(--line)] bg-white/72 p-6">
          <p className="eyebrow text-[var(--ink-soft)]">일별 흐름</p>
        ...
        <div className="grid gap-6">
          <div className="rounded-[28px] border border-[var(--line)] bg-white/72 p-6">
            <p className="eyebrow text-[var(--ink-soft)]">카테고리 매출</p>
          ...
          <div className="rounded-[28px] border border-[var(--line)] bg-white/72 p-6">
            <p className="eyebrow text-[var(--ink-soft)]">상위 상품</p>
            <div className="mt-5 grid gap-3">
                ...
                >
                  <div>
                    ...
                    <p className="text-[var(--ink-soft)]">
                      {item.categoryName} / {item.quantity}개 판매
                    </p>
                  </div>
                  <p>{formatPrice(item.revenue)}원</p>
                </div>
