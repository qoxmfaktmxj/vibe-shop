...
export function getSocialLoginErrorMessage(error?: string | null) {
  switch (error) {
    case "social_google_unavailable":
      return "Google 로그인은 아직 연결되지 않았습니다. Client ID와 redirect URI를 설정한 뒤 다시 시도해 주세요.";
    case "social_kakao_unavailable":
      return "카카오 로그인은 아직 연결되지 않았습니다. Client ID와 redirect URI를 설정한 뒤 다시 시도해 주세요.";
    case "unsupported_provider":
      return "지원하지 않는 소셜 로그인 방식입니다.";
    case "invalid_state":
      return "소셜 로그인 상태 확인에 실패했습니다. 다시 시도해 주세요.";
    case "missing_code":
      return "소셜 로그인 승인 코드가 전달되지 않았습니다.";
    ...
    case "email_required":
      return "이메일 제공 동의가 필요합니다. 공급자 동의 화면에서 이메일 권한을 허용해 주세요.";
    case "social_exchange_failed":
      return "소셜 계정을 쇼핑몰 세션으로 연결하지 못했습니다.";
    case "unexpected":
      return "소셜 로그인 처리 중 예상하지 못한 문제가 발생했습니다.";
    default:
      return "";
  }
}
