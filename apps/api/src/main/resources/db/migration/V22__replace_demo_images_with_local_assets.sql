...
SET image_url = '/images/products/' || ranked_products.category_slug || '-' || LPAD((((ranked_products.image_rank - 1) % 50) + 1)::TEXT, 2, '0') || '.jpg',
...
SET image_url = '/images/products/' || ranked_review_images.category_slug || '-' || LPAD((((ranked_review_images.image_rank - 1) % 50) + 1)::TEXT, 2, '0') || '.jpg'
